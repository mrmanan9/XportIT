...
const FrontOfBillOfExport = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.frontOfBillOfExport}>
      <View style={[styles.frontNid, styles.frontLayout]}>
        <Pressable
          style={styles.frontNidChild}
          onPress={() => navigation.navigate("FircNumber")}
        />
        ...
        <Text style={[styles.takeAFront, styles.continueTypo]}>
          Take a front photo of your Bill of Export
        </Text>
      </View>
    </View>
  );
...
export default FrontOfBillOfExport;
