...
const FrontOfPancard = () => {
  const navigation = useNavigation();

  return (
    <Pressable
      style={styles.frontOfPancard}
      onPress={() => navigation.navigate("NIDVerifying1")}
    >
      <View style={[styles.frontNid, styles.frontLayout]}>
        <View style={styles.frontNidChild} />
        ...
        <Text style={[styles.takeAFront, styles.continueTypo]}>
          Take a front photo of your PAN CARD
        </Text>
      </View>
    </Pressable>
  );
